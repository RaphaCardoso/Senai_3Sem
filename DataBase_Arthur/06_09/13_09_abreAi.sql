...
-- Selecionar todos os pedidos de um cliente
SELECT
cli.nome,
pedidos.data_pedido,
pedidos.id_pedido,
...
INNER JOIN produtos ON  produtos.id_produto = pedidos.id_pedido
...
-- INNER JOIN -> clientes, clientes -> cidades
SELECT 
...
-- Você precisa identificar o produto do pedido,
-- o funcionário que atendeu nesse pedido
-- e o cliente que não ficou satisfeito
	SELECT 
	ped.id_pedido,
	produtos.nome_produto AS NomeProduto,
	funcionarios.nome_funcionario AS NomeFuncionario,
	clientes.nome AS NomeCliente
	FROM pedidos ped 
	INNER JOIN produtos ON produtos.id_produto = ped.id_produto
	INNER JOIN funcionarios ON funcionarios.id_funcionario = ped.id_funcionario
	INNER JOIN clientes ON clientes.id_cliente = ped.id_cliente;